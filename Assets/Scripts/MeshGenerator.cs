...
public static class MeshGenerator {
    ...
    public static MeshData GenerateTerrainMesh2(float[,] heightMap, MeshSettings meshSettings, int levelOfDetail, float[,] heatMap)
    {
        ...
        for (int y = 0; y < numVertsPerLine; y++)
        {
            for (int x = 0; x < numVertsPerLine; x++)
            {
                ...
                if (!isSkippedVertex)
                {
                    ...
                    meshData.AddVertex2(new Vector3(vertexPosition2D.x, height, vertexPosition2D.y), percent, vertexIndex, new Vector2(heat,heat));
...
public class MeshData {
    ...
    public void AddVertex2(Vector3 vertexPosition, Vector2 uv, int vertexIndex, Vector2 uv2)
    {
        if (vertexIndex < 0)
        {
            outOfMeshVertices[-vertexIndex - 1] = vertexPosition;
